...
# Load kedua dataset
day_data = pd.read_csv('D:\Faizz\Kursus\DICODING\Analisis Data Bike\bike-sharing-dashboard-1\day.csv')
hour_data = pd.read_csv('D:\Faizz\Kursus\DICODING\Analisis Data Bike\bike-sharing-dashboard-1\hour.csv')
